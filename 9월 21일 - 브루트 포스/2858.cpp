...
int main() {
    ...
    //입력
    cin >> r >> b; //빨간 타일, 갈색 타일 수 입력

    //연산
    pair<int, int> result = length(r, b); //높이, 넓이 계산
